...
main = html.Div([
    dbc.Tabs([
        dbc.Tab(design_tab,
                ...
                tab_id="tab-design",
                label=html.Span([html.I(className="bi bi-grid-3x3 me-2"), "Design"])),
        dbc.Tab(analysis_tab,
                label_style={"fontWeight": 600},
                tab_id="tab-analysis",
                label=html.Span([html.I(className="bi bi-bar-chart-line me-2"), "Analysis"])),
        dbc.Tab(prediction_tab,
                label_style={"fontWeight": 600},
                tab_id="tab-prediction",
                label=html.Span([html.I(className="bi bi-bullseye me-2"), "Prediction & Optimization"])),
        dbc.Tab(agent_tab,
                label_style={"fontWeight": 600, "color": "#2C7BE5"},
                tab_id="tab-agent",
                label=html.Span([html.I(className="bi bi-robot me-2"), "AI Assistant"])),
